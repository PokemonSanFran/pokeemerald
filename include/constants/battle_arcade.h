...
#define ARCADE_PALTAG_ALL                 ARCADE_PALTAG_EVENT + ARCADE_IMPACT_ALL
#define ARCADE_PALTAG_SPECIAL                 ARCADE_PALTAG_EVENT + ARCADE_IMPACT_SPECIAL
#define ARCADE_PALTAG_COUNTDOWN 4096
