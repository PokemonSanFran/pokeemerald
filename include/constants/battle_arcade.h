...
#define ARCADE_GFXTAG_BURN              ARCADE_GFXTAG + ARCADE_EVENT_BURN
#define ARCADE_GFXTAG_SLEEP             ARCADE_GFXTAG + ARCADE_EVENT_SLEEP
#define ARCADE_GFXTAG_FREEZE            ARCADE_GFXTAG + ARCADE_EVENT_FREEZE
#define ARCADE_GFXTAG_GIVE_BERRY        ARCADE_GFXTAG + ARCADE_EVENT_GIVE_BERRY
#define ARCADE_GFXTAG_GIVE_ITEM         ARCADE_GFXTAG + ARCADE_EVENT_GIVE_ITEM
#define ARCADE_GFXTAG_LEVEL_UP          ARCADE_GFXTAG + ARCADE_EVENT_LEVEL_UP
#define ARCADE_GFXTAG_SUN               ARCADE_GFXTAG + ARCADE_EVENT_SUN
#define ARCADE_GFXTAG_RAIN              ARCADE_GFXTAG + ARCADE_EVENT_RAIN
#define ARCADE_GFXTAG_SAND              ARCADE_GFXTAG + ARCADE_EVENT_SAND
#define ARCADE_GFXTAG_HAIL              ARCADE_GFXTAG + ARCADE_EVENT_HAIL
#define ARCADE_GFXTAG_FOG               ARCADE_GFXTAG + ARCADE_EVENT_FOG
#define ARCADE_GFXTAG_TRICK_ROOM        ARCADE_GFXTAG + ARCADE_EVENT_TRICK_ROOM
#define ARCADE_GFXTAG_SWAP              ARCADE_GFXTAG + ARCADE_EVENT_SWAP
#define ARCADE_GFXTAG_SPEED_UP          ARCADE_GFXTAG + ARCADE_EVENT_SPEED_UP
#define ARCADE_GFXTAG_SPEED_DOWN        ARCADE_GFXTAG + ARCADE_EVENT_SPEED_DOWN
#define ARCADE_GFXTAG_RANDOM            ARCADE_GFXTAG + ARCADE_EVENT_RANDOM
#define ARCADE_GFXTAG_GIVE_BP_SMALL     ARCADE_GFXTAG + ARCADE_EVENT_GIVE_BP_SMALL
#define ARCADE_GFXTAG_NO_BATTLE         ARCADE_GFXTAG + ARCADE_EVENT_NO_BATTLE
#define ARCADE_GFXTAG_GIVE_BP_BIG       ARCADE_GFXTAG + ARCADE_EVENT_GIVE_BP_BIG
#define ARCADE_GFXTAG_NO_EVENT          ARCADE_GFXTAG + ARCADE_EVENT_NO_EVENT

#define ARCADE_GFXTAG_COUNTDOWN         2000
#define ARCADE_GFXTAG_COUNTDOWN_1       ARCADE_GFXTAG_COUNTDOWN + ARCADE_BOARD_MODE_COUNTDOWN_1
#define ARCADE_GFXTAG_COUNTDOWN_2       ARCADE_GFXTAG_COUNTDOWN + ARCADE_BOARD_MODE_COUNTDOWN_2
#define ARCADE_GFXTAG_COUNTDOWN_3       ARCADE_GFXTAG_COUNTDOWN + ARCADE_BOARD_MODE_COUNTDOWN_3

#define ARCADE_GFXTAG_CURSOR            3000
