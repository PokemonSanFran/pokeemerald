...
#define ARCADE_PALTAG_ALL                 ARCADE_PALTAG_EVENT + ARCADE_IMPACT_OPPONENT
#define ARCADE_PALTAG_SPECIAL                 ARCADE_PALTAG_EVENT + ARCADE_IMPACT_OPPONENT

#define ARCADE_PALTAG_COUNTDOWN         3000
