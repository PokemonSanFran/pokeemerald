...
#define FLAG_SYS_USE_CUT                            (SYSTEM_FLAGS + 0x24) // frictionless_field_moves Branch
#define FLAG_SYS_USE_SURF                           (SYSTEM_FLAGS + 0x25) // frictionless_field_moves Branch
#define FLAG_SYS_USE_ROCK_SMASH                     (SYSTEM_FLAGS + 0x26) // frictionless_field_moves Branch
#define FLAG_SYS_USE_WATERFALL                      (SYSTEM_FLAGS + 0x27) // frictionless_field_moves Branch
