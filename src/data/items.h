...
// Hold items
    ...
    [ITEM_SECRETPOWER_TOOL] =
    {
        .name = _("SecretPwrTool"),
        .itemId = ITEM_SECRETPOWER_TOOL,
        .price = 0,
        .importance = 1,
        .description = sSecretPower_ToolDesc,
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_FIELD,
        .fieldUseFunc = ItemUseOutOfBattle_SecretPower_Tool,
    },
