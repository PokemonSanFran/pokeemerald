...
static const VsSeekerData sVsSeekerData[] = {
    ...
    {{TRAINER_ROXANNE_1, TRAINER_ROXANNE_2, TRAINER_ROXANNE_3, TRAINER_ROXANNE_4, TRAINER_ROXANNE_5, MAP_GROUP(RUSTBORO_CITY), MAP_NUM(RUSTBORO_CITY)}},
    {{TRAINER_BRAWLY_1, TRAINER_BRAWLY_2, TRAINER_BRAWLY_3, TRAINER_BRAWLY_4, TRAINER_BRAWLY_5, MAP_GROUP(DEWFORD_TOWN), MAP_NUM(DEWFORD_TOWN)}},
    {{TRAINER_WATTSON_1, TRAINER_WATTSON_2, TRAINER_WATTSON_3, TRAINER_WATTSON_4, TRAINER_WATTSON_5, MAP_GROUP(MAUVILLE_CITY), MAP_NUM(MAUVILLE_CITY)}},
    {{TRAINER_FLANNERY_1, TRAINER_FLANNERY_2, TRAINER_FLANNERY_3, TRAINER_FLANNERY_4, TRAINER_FLANNERY_5, MAP_GROUP(LAVARIDGE_TOWN), MAP_NUM(LAVARIDGE_TOWN)}},
    {{TRAINER_NORMAN_1, TRAINER_NORMAN_2, TRAINER_NORMAN_3, TRAINER_NORMAN_4, TRAINER_NORMAN_5, MAP_GROUP(PETALBURG_CITY), MAP_NUM(PETALBURG_CITY)}},
    {{TRAINER_WINONA_1, TRAINER_WINONA_2, TRAINER_WINONA_3, TRAINER_WINONA_4, TRAINER_WINONA_5, MAP_GROUP(FORTREE_CITY), MAP_NUM(FORTREE_CITY)}},
    {{TRAINER_TATE_AND_LIZA_1, TRAINER_TATE_AND_LIZA_2, TRAINER_TATE_AND_LIZA_3, TRAINER_TATE_AND_LIZA_4, TRAINER_TATE_AND_LIZA_5, MAP_GROUP(MOSSDEEP_CITY), MAP_NUM(MOSSDEEP_CITY)}},
    {{TRAINER_JUAN_1, TRAINER_JUAN_2, TRAINER_JUAN_3, TRAINER_JUAN_4, TRAINER_JUAN_5, MAP_GROUP(SOOTOPOLIS_CITY), MAP_NUM(SOOTOPOLIS_CITY)}},
    {{TRAINER_SIDNEY, TRAINER_SIDNEY, TRAINER_SIDNEY, TRAINER_SIDNEY, TRAINER_SIDNEY, MAP_GROUP(EVER_GRANDE_CITY), MAP_NUM(EVER_GRANDE_CITY)}},
    {{TRAINER_PHOEBE, TRAINER_PHOEBE, TRAINER_PHOEBE, TRAINER_PHOEBE, TRAINER_PHOEBE, MAP_GROUP(EVER_GRANDE_CITY), MAP_NUM(EVER_GRANDE_CITY)}},
    {{TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, MAP_GROUP(EVER_GRANDE_CITY), MAP_NUM(EVER_GRANDE_CITY)}},
    {{TRAINER_DRAKE, TRAINER_DRAKE, TRAINER_DRAKE, TRAINER_DRAKE, TRAINER_DRAKE, MAP_GROUP(EVER_GRANDE_CITY), MAP_NUM(EVER_GRANDE_CITY)}},
    {{TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, MAP_GROUP(EVER_GRANDE_CITY), MAP_NUM(EVER_GRANDE_CITY)}},
};
